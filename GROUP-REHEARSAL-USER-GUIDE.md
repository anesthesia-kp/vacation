# Vacation Auction — Practice Run: What To Do

We're doing a ~40-minute practice auction so everyone can try the system before the real one.
**It's all pretend vacation — nothing you bid on counts** — but the system is real, so you'll
get real e-mails and see exactly how the real auction will work.

## Before rehearsal day (takes 2 minutes — please do this NOW)

1. On your phone, open: **https://anesthesia-kp.github.io/vacation/**
2. Sign in with your Google account. If sign-in fails, tell Aaron TODAY.
3. **Whitelist the auction's e-mail sender** (add it to your contacts / mark not-spam) and tap
   the site's confirm button when it asks. Without this, your outbid alerts may go to spam —
   in the real auction that could cost you a week you wanted.
...
3. A few minutes later your **results e-mail** arrives — write what it says, and mark
   **Match? Y/N** against what was projected.

Some rounds Aaron will ask you to deliberately try things that should be REFUSED (like reusing
a bid number). If the site refuses with a clear message — that's a pass, not a problem.

## The 3 things we need from you
